package com.xinyunlian.jinfu.report.loan.entity;

import com.xinyunlian.jinfu.report.loan.enums.*;
import com.xinyunlian.jinfu.report.loan.enums.converter.*;
 ...
 */
@Entity
@Table(name = "fp_loan_dtl_real")
public class LoanDtlPo implements Serializable {
