...
import com.xinyunlian.jinfu.report.loan.enums.converter.ETransModeEnumConverter;
 ...
 */
@Entity
@Table(name = "fp_repay_dtl_real")
public class RepayDtlPo implements Serializable {
