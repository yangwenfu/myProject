...
import com.xinyunlian.jinfu.report.loan.enums.converter.EScheduleStatusEnumConverter;
 ...
 */
@Entity
@Table(name = "fp_repay_schd_real")
public class RepaySchedulePo implements Serializable {
