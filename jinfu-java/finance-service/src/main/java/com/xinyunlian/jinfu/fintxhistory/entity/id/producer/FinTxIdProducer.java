package com.xinyunlian.jinfu.fintxhistory.entity.id.producer;
 ...
 */
public class FinTxIdProducer  extends DefaultIdProducer<FinTxHistoryPo> {

    private static final String FIN_TX_ID_FORMAT = "20{0}";
    ...
    protected Object doProduceId(Context ctx) {
        ...
        return MessageFormat.format(FIN_TX_ID_FORMAT, sb);
    }
