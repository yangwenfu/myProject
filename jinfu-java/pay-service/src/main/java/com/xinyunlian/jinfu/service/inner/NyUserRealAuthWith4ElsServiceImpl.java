 ...
 */
public class NyUserRealAuthWith4ElsServiceImpl implements UserRealAuthService{
    @Override
    ...
    private NYRealAuthResponse execute(UserRealAuthDto realAuthDto){
        ...
        nyRealAuthRequest.setPhone(realAuthDto.getPhone());
        nyRealAuthRequest.setTransType(NYRealAuthRequest.AUTH_WITH_4ELS);
        nyRealAuthRequest.setExecuteUrl(AppConfigUtil.getConfig("ny.domain")+"/verif/Verification4");
