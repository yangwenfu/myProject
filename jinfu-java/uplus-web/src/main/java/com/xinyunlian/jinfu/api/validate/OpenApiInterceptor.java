...
import com.xinyunlian.jinfu.system.service.ThirdConfigService;
    ...
    public void validate1(final JoinPoint jp) {
        ...
        for (Object arg : args
            ...
            if (arg instanceof OpenApiBaseDto) {
                ...
                ThirdConfigDto thirdConfigDto = thirdConfigService.findByAppId(validatedObj.getAppId());
                String key;
                if (thirdConfigDto != null) {
                    key = thirdConfigDto.getKey();
                } else {
                    key = AppConfigUtil.getConfig(validatedObj.getAppId());
                }
