 ...
 */
public class ProdCodeDetailDto implements Serializable {
    ...
    private List<ScanCodeRecordDto> scanCodeRecordList = new ArrayList<>();
    ...
    public List<ScanCodeRecordDto> getScanCodeRecordList() {
        return scanCodeRecordList;
    }

    public void setScanCodeRecordList(List<ScanCodeRecordDto> scanCodeRecordList) {
        this.scanCodeRecordList = scanCodeRecordList;
    }
}
