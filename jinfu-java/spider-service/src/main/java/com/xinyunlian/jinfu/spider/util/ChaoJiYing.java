...
/**
 * Created by carrot on 2017/8/4.
 */
public class ChaoJiYing {

    private static final String CHAOJIYING_USERNAME = "13262285197";

    private static final String CHAOJIYING_PWD = "cjycjy123";

    private static final String CHAOJIYING_SOFTID = "893804";
    ...
    public static String GetScore() {
        String param = String.format("user=%s&pass=%s", CHAOJIYING_USERNAME, CHAOJIYING_PWD);
        String result;
        try {
    ...
    public static String ReportError(String id) {
        ...
        String param = String
                .format(
                        ...
                        CHAOJIYING_USERNAME, CHAOJIYING_PWD, CHAOJIYING_SOFTID, id);
        String result;
        try {
            result = ChaoJiYing.httpRequestData(
     ...
     * @throws IOException
     */
    public static String PostPic(String codetype, String len_min, String filePath) {
        String result = "";
        String param = String
                .format(
                        "user=%s&pass=%s&softid=%s&codetype=%s&len_min=%s", CHAOJIYING_USERNAME, CHAOJIYING_PWD, CHAOJIYING_SOFTID, codetype, len_min);
        try {
     ...
     * @throws IOException
     */
    public static String PostPic(String codetype, String len_min, byte[] byteArr) {
        String result = "";
        String param = String
                .format(
                        "user=%s&pass=%s&softid=%s&codetype=%s&len_min=%s", CHAOJIYING_USERNAME, CHAOJIYING_PWD, CHAOJIYING_SOFTID, codetype, len_min);
